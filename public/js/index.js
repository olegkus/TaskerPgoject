...
/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
if (!personid) {
    let loginControl = new _login__WEBPACK_IMPORTED_MODULE_1__["default"](_database__WEBPACK_IMPORTED_MODULE_0___default.a);
    loginControl.render();
} else {
    ...
    _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderTasksPage(_database__WEBPACK_IMPORTED_MODULE_0___default.a, person);

    function menuItemClickFunction(menu_item_hash) {
        switch (menu_item_hash) {
            case '#tasks':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderTasksPage(_database__WEBPACK_IMPORTED_MODULE_0___default.a, person);break;
            case '#newtask':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderNewTaskPage(_database__WEBPACK_IMPORTED_MODULE_0___default.a, person);break;
            case '#agents':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderAgentsGallery();break;
            case '#managers':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderManagersGallery();break;
            case '#contacts':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderContactsPage();break;
            case '#mailbox':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].renderMailboxPage(_database__WEBPACK_IMPORTED_MODULE_0___default.a, person);break;
            case '#profile':
                break;
            case '#logout':
                _menuActions__WEBPACK_IMPORTED_MODULE_4__["default"].Logout();break;
            default:
                break;
        }
    }
...
module.exports = {
	"persons": [{
		"type": "Manager",
		"id": "396e0c4609e44b1997dbbd423774a4b3",
		"name": "Barack",
		"surname": "Obama",
		"email": "barack.obama@test.tt",
		"login": "bo",
		"password": "hello",
		"photo": "2.jpg"
	}, {
		"type": "Agent",
		"id": "nvcjf1hs7tf8yyk4lmlijqkuo9",
		"name": "James",
		"surname": "Bond",
		"email": "james.bond@test.tt",
		"login": "jb",
		"password": "hello",
		"photo": "agent1.jpg"
	}, {
	...
	"tasks": [{
		"type": "Task",
		"id": "36dh5sec7zdj90sk2rx7pjswi2",
		"title": "Mission 1",
		"details": "Get important document from NATA office",
		"status": "new",
		"managerid": "396e0c4609e44b1997dbbd423774a4b3",
		"agentid": "nvcjf1hs7tf8yyk4lmlijqkuo9"
	}, {
		"type": "Task",
		"id": "36dh5sec7zdj90sk2rx7pjswi2",
		"title": "Mission 1",
...
class LoginControl {
    constructor(database) {
        ...
        this.render = function () {
            ...
            document.body.innerHTML = __webpack_require__(10);
...
module.exports = __webpack_require__.p + "img/slider/mi12.jpg";
...
module.exports = "\r\n<div class=\"login-table\">\r\n    <form action=\"#\">\r\n        <p>\r\n            <strong>Login</strong>\r\n            <input maxlength=\"25\" size=\"30\" id=\"login\" required>\r\n        </p>\r\n        <p>\r\n            <strong>Password</strong>\r\n            <input type=\"password\" maxlength=\"25\" size=\"30\" id=\"password\" required>\r\n        </p>\r\n        <p class=\"login-button\">\r\n            <input type=\"button\" value=\"Login\" id=\"loginBtn\">\r\n        </p>\r\n    </form>\r\n</div>\r\n";
...
class MenuControl {
    constructor(menuItems, menuItemClickFunction) {
        ...
        this.render = function () {
            ...
            let menuHtml = _.template(__webpack_require__(12))(menuItems);
...
module.exports = "\r\n\r\n<div class=\"wrapper\">\r\n    <ul class=\"menu\">\r\n        <% items.forEach((item)=> { %>\r\n            <li class=\"menu_item\">\r\n            <a class=\"menu_link\" href=\"<%-item.href%>\">\r\n                <%=item.text%>\r\n            </a>\r\n                \r\n                <% if(item.items) {%>\r\n                <ul class=\"submenu\">\r\n                    <% for(let sub of item.items){%>\r\n                    <li class=\"submenu_item\">\r\n                    <a class=\"menu_link\" href=\"<%-sub.href%>\">\r\n                        <%=sub.text%>\r\n                        </a>\r\n                    </li>\r\n                    <%}%>\r\n                </ul>\r\n                <%}%>\r\n\r\n            </li>\r\n            <% }); %>\r\n    </ul>\r\n</div>";
